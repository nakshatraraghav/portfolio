---
title: "Sentimetric"
description: "Sentimetric is an API that enables users to perform string analysis operations like similarity checks, sentiment analysis, and phonetic comparisons, all protected by API key authentication."
---
