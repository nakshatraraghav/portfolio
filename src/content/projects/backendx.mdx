---
title: "backendx"
description: "A streamlined template for Go backend projects, featuring go-chi routing, Prometheus monitoring, Grafana visualization, zerolog logging, and Loki log aggregation. Simplify development with environment variable validation and a user-friendly Makefile for building, testing, running, and load testing"
---
